...
Accessing the public data members of a class:
...
int main()
{
    ...
    aObj.*nptr = 2;
    cout << "Accessing public member using a pointer defined in the class: " << aObj.*nptr << "\n";

    aptr->n = 3;
    cout << "Accessing public member using an object pointer: " << aptr->n << "\n";

    aObj.*nptr = 4;
    cout << "Accessing public member using object name and class member pointer: " << aObj.*nptr << "\n";

    aptr->*nptr = 5;
    cout << "Accessing public member using an object pointer and class member pointer: " << aptr->*nptr << "\n";
