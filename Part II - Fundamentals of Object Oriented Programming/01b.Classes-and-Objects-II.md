...
* Friend functions are mostly used during operator overloading.
...
Member functions of one class can be friend functions of another class, all member functions of one class can be made as the friend functions of another class by declaring it as a **friend class**.
