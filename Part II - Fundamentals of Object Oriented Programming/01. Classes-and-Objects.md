...
The other limitations include - (1) structures in C do not permit data hiding, structure members can be directly accessed using structure variables by any function in their scope (2) structures in C cannot have member functions.
