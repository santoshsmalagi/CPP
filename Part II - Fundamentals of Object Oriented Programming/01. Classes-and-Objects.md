...
void rectangleAreaPerimeter(float ln, float br)
{
  ...
  static char unit = 'm';                            // static variable can be accessed by member functions of a local class
	...
	class Calculate
	{
      ...
      operationCount++;                             // illegal, local variable cannot be accessed by member functions of a local class
		...
		void print()
		{
			cout << "Area: " << area << "sq" << units << "Perimeter: " << perimeter << unit;  // static variables of the enclosing function can be accessed
		}
